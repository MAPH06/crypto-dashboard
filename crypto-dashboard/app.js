...
const TOP_BASES = [
  ...
  // ── Overige munten (alfabetisch) ─────────────────────────
  { id: '1INCH',  name: '1inch'               },
  { id: 'AAVE',   name: 'Aave'                },
  { id: 'ACH',    name: 'Alchemy Pay'         },
  { id: 'ACT',    name: 'Act I'               },
  { id: 'ADA',    name: 'Cardano'             },
  { id: 'AEVO',   name: 'Aevo'                },
  ...
  { id: 'GTC',    name: 'Gitcoin'             },
  { id: 'HBAR',   name: 'Hedera'              },
  { id: 'HIGH',   name: 'Highstreet'          },
  { id: 'HNT',    name: 'Helium'              },
  { id: 'HOOK',   name: 'Hooked Protocol'     },
  { id: 'HOT',    name: 'Holo'                },
  { id: 'ICP',    name: 'Internet Computer'   },
  { id: 'ID',     name: 'SPACE ID'            },
  { id: 'ILV',    name: 'Illuvium'            },
  ...
  { id: 'KAVA',   name: 'Kava'                },
  { id: 'KDA',    name: 'Kadena'              },
  { id: 'KNC',    name: 'Kyber Network'       },
  { id: 'KSM',    name: 'Kusama'              },
  { id: 'LDO',    name: 'Lido DAO'            },
  { id: 'LINK',   name: 'Chainlink'           },
  { id: 'LIT',    name: 'Litentry'            },
  { id: 'LOKA',   name: 'League of Kingdoms'  },
  { id: 'LPT',    name: 'Livepeer'            },
  ...
  { id: 'QTUM',   name: 'Qtum'                },
  { id: 'RAY',    name: 'Raydium'             },
  { id: 'RDNT',   name: 'Radiant Capital'     },
  { id: 'REEF',   name: 'Reef'                },
  { id: 'REQ',    name: 'Request'             },
  { id: 'REZ',    name: 'Renzo Protocol'      },
  { id: 'RLC',    name: 'iExec RLC'           },
  { id: 'RNDR',   name: 'Render'              },
  { id: 'ROSE',   name: 'Oasis Network'       },
  { id: 'RPL',    name: 'Rocket Pool'         },
  ...
  { id: 'SKL',    name: 'SKALE'               },
  { id: 'SLP',    name: 'Smooth Love Potion'  },
  { id: 'SNX',    name: 'Synthetix'           },
  { id: 'SOL',    name: 'Solana'              },
  { id: 'SOLV',   name: 'Solv Protocol'       },
  { id: 'SPELL',  name: 'Spell Token'         },
  { id: 'SSV',    name: 'SSV Network'         },
  { id: 'STG',    name: 'Stargate Finance'    },
  { id: 'STRK',   name: 'Starknet'            },
  { id: 'STX',    name: 'Stacks'              },
  { id: 'SUI',    name: 'Sui'                 },
  { id: 'SUPER',  name: 'SuperFarm'           },
  { id: 'SXP',    name: 'Solar'               },
  { id: 'SYN',    name: 'Synapse'             },
  { id: 'T',      name: 'Threshold'           },
